...
def import_obs(param, area):
	...
	arq   = '{0}/{1}_{2}_cru_ts4.05_obs_yr_1961-2014_lonlat.nc'.format(path, param, area)	
...
def import_cmip(path, param, area, cmip, exp, date):
	...
	arq   = '{0}/{1}_{2}_Ayr_{3}_historical_{4}_{5}_lonlat_mask.nc'.format(path, param, area, cmip, exp, date)	
