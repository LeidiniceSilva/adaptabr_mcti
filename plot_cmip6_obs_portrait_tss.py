...
sort_list_namz = sort_list(tss_namz_cmip6)
model_list_namz = []
value_list_namz = []
for i in sort_list_namz:
	model_list_namz.append(cmip6[i+1][0])
	value_list_namz.append(tss_namz_cmip6[i])

sort_list_samz = sort_list(tss_samz_cmip6)
model_list_samz = []
value_list_samz = []
for ii in sort_list_samz:
	model_list_samz.append(cmip6[ii+1][0])
	value_list_samz.append(tss_samz_cmip6[ii])

sort_list_neb = sort_list(tss_neb_cmip6)
model_list_neb = []
value_list_neb = []
for iii in sort_list_neb:
	model_list_neb.append(cmip6[iii+1][0])
	value_list_neb.append(tss_neb_cmip6[iii])

sort_list_sam = sort_list(tss_sam_cmip6)
model_list_sam = []
value_list_sam = []
for iv in sort_list_sam:
	model_list_sam.append(cmip6[iv+1][0])
	value_list_sam.append(tss_sam_cmip6[iv])

sort_list_lpb = sort_list(tss_lpb_cmip6)
model_list_lpb = []
value_list_lpb = []
for v in sort_list_lpb:
	model_list_lpb.append(cmip6[v+1][0])
	value_list_lpb.append(tss_lpb_cmip6[v])
...
name_out = 'pyplt_rank_tss_cmip6_{0}_{1}.png'.format(var_cmip6, dt)
