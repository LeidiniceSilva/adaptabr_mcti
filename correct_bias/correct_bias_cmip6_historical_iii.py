# -*- coding: utf-8 -*-
"""correct_bias_cmip6_historical_sully.ipynb

Automatically generated by Colaboratory.

Original file is located at
	https://colab.research.google.com/drive/1ulOWG7zNVX3Cd0Vv9ExW-OS3l-rbTqq5
"""
...
"""
# Calculate st.mielke parameters
obs_k, obs_s, obs_loc, obs_scale = st.mielke.fit(obs)
obs_params = obs_k, obs_s, obs_loc, obs_scale

sim_k, sim_s, sim_loc, sim_scale = st.mielke.fit(sim)
...
corrected_data = quantile_mapping(sim, sim_params, st.mielke, obs_params, st.mielke)
