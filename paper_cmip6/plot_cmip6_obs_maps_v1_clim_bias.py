...
ct6 = ax6.contour(lon, lat, bias_mme_obs_pr, levels=np.arange(-8, 12, 4), linewidths=0.6, colors='black')
ax6.clabel(ct1, fontsize=font_size, colors='black')
...
ct7 = ax7.contour(lon, lat, bias_mme_best_obs_pr, levels=np.arange(-8, 12, 4), linewidths=0.6, colors='black')
...
ct8 = ax8.contour(lon, lat, bias_mme_worse_obs_pr, levels=np.arange(-8, 12, 4), linewidths=0.6, colors='black')
...
ct14 = ax14.contour(lon, lat, bias_mme_obs_ps, levels=np.arange(-8, 12, 4), linewidths=0.6, colors='black')
ax14.clabel(ct14, fontsize=font_size, colors='black')
...
ct15 = ax15.contour(lon, lat, bias_mme_best_obs_ps, levels=np.arange(-8, 12, 4), linewidths=0.6, colors='black')
ax15.clabel(ct15, fontsize=font_size, colors='black')
...
ct16 = ax16.contour(lon, lat, bias_mme_worse_obs_ps, levels=np.arange(-8, 12, 4), linewidths=0.6, colors='black')
ax16.clabel(ct16, fontsize=font_size, colors='black')
