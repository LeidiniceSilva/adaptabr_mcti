...
cf1 = ax1.contourf(lon, lat, bias_mme_obs_t_200, levels=np.arange(-9, 10, 1), transform=ccrs.PlateCarree(), extend='both', cmap=cmap_color)
...
cf2 = ax2.contourf(lon, lat, bias_mme_best_obs_t_200, levels=np.arange(-9, 10, 1), transform=ccrs.PlateCarree(), extend='both', cmap=cmap_color)
...
cf3 = ax3.contourf(lon, lat, bias_mme_worse_obs_t_200, levels=np.arange(-9, 10, 1), transform=ccrs.PlateCarree(), extend='both', cmap=cmap_color)
...
cf4 = ax4.contourf(lon, lat, bias_mme_obs_t_500, levels=np.arange(-9, 10, 1), transform=ccrs.PlateCarree(), extend='both', cmap=cmap_color)
...
cf5 = ax5.contourf(lon, lat, bias_mme_best_obs_t_500, levels=np.arange(-9, 10, 1), transform=ccrs.PlateCarree(), extend='both', cmap=cmap_color)
...
cf6 = ax6.contourf(lon, lat, bias_mme_worse_obs_t_500, levels=np.arange(-9, 10, 1), transform=ccrs.PlateCarree(), extend='both', cmap=cmap_color)
...
cf7 = ax7.contourf(lon, lat, bias_mme_obs_t_850, levels=np.arange(-9, 10, 1), transform=ccrs.PlateCarree(), extend='both', cmap=cmap_color)
...
cf8 = ax8.contourf(lon, lat, bias_mme_best_obs_t_850, levels=np.arange(-9, 10, 1), transform=ccrs.PlateCarree(), extend='both', cmap=cmap_color)
...
cf9 = ax9.contourf(lon, lat, bias_mme_worse_obs_t_850, levels=np.arange(-9, 10, 1), transform=ccrs.PlateCarree(), extend='both', cmap=cmap_color)
