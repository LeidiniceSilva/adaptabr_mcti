...
for i in range(1, 18):
	...
	namz_cmip_u850, namz_cmip_u500, namz_cmip_u200, = import_cmip_atm('ta', 'namz', cmip6[i][0], cmip6[i][1], dt)
	namz_cmip_v850, namz_cmip_v500, namz_cmip_v200, = import_cmip_atm('ta', 'namz', cmip6[i][0], cmip6[i][1], dt)
	namz_cmip_q850, namz_cmip_q500, namz_cmip_q200, = import_cmip_atm('ta', 'namz', cmip6[i][0], cmip6[i][1], dt)

	m1_namz_pr.append(compute_mbe(namz_cmip_pr, namz_obs_pr))
	m1_namz_ps.append(compute_mbe(namz_cmip_ps, namz_obs_ps))
	m1_namz_t850.append(compute_mbe(namz_cmip_t850, namz_obs_t850))
	m1_namz_t500.append(compute_mbe(namz_cmip_t500, namz_obs_t500))
	m1_namz_t200.append(compute_mbe(namz_cmip_t200, namz_obs_t200))
	m1_namz_u850.append(compute_mbe(namz_cmip_u850, namz_obs_u850))
	m1_namz_u500.append(compute_mbe(namz_cmip_u500, namz_obs_u500))
	m1_namz_u200.append(compute_mbe(namz_cmip_u200, namz_obs_u200))
	m1_namz_v850.append(compute_mbe(namz_cmip_v850, namz_obs_v850))
	m1_namz_v500.append(compute_mbe(namz_cmip_v500, namz_obs_v500))
	m1_namz_v200.append(compute_mbe(namz_cmip_v200, namz_obs_v200))
	m1_namz_q850.append(compute_mbe(namz_cmip_q850, namz_obs_q850))
	m1_namz_q500.append(compute_mbe(namz_cmip_q500, namz_obs_q500))
	m1_namz_q200.append(compute_mbe(namz_cmip_q200, namz_obs_q200))
...
norm = colors.BoundaryNorm(boundaries=np.arange(-6, 7, 1), ncolors=256)
color = cm.BrBG
...
pcm = ax.pcolormesh(m1_namz, edgecolors='white', linewidths=2., norm=norm, cmap=color)
