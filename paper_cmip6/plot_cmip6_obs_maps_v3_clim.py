...
cf1 = ax1.contourf(lon, lat, q_200_obs, levels=np.arange(0, 0.1, 0.00125), transform=ccrs.PlateCarree(), extend='max', cmap=cmap_color)
st1 = ax1.streamplot(lon, lat, u_200_obs[:,:], v_200_obs[:,:], arrowsize=1, arrowstyle='->', color='black', density=1, linewidth=0.5)
...
cf2 = ax2.contourf(lon, lat, q_200_mme, levels=np.arange(0, 0.1, 0.00125), transform=ccrs.PlateCarree(), extend='max', cmap=cmap_color)
st2 = ax2.streamplot(lon, lat, u_200_mme[:,:], v_200_mme[:,:], arrowsize=1, arrowstyle='->', color='black', density=1, linewidth=0.5)
ax2.set_title('(b) MME', loc='left', fontsize=font_size, fontweight='bold')
configure_subplot(ax2)

cf3 = ax3.contourf(lon, lat, q_200_mme_best, levels=np.arange(0, 0.1, 0.00125), transform=ccrs.PlateCarree(), extend='max', cmap=cmap_color)
st3 = ax3.streamplot(lon, lat, u_200_mme_best[:,:], v_200_mme_best[:,:], arrowsize=1, arrowstyle='->', color='black', density=1, linewidth=0.5)
ax3.set_title('(c) MME-best', loc='left', fontsize=font_size, fontweight='bold')
configure_subplot(ax3)

cf4 = ax4.contourf(lon, lat, q_200_mme_worse, levels=np.arange(0, 0.1, 0.00125), transform=ccrs.PlateCarree(), extend='max', cmap=cmap_color)
st4 = ax4.streamplot(lon, lat, u_200_mme_worse[:,:], v_200_mme_worse[:,:], arrowsize=1, arrowstyle='->', color='black', density=1, linewidth=0.5)
...
st5 = ax5.streamplot(lon, lat, u_500_obs[:,:], v_500_obs[:,:], arrowsize=1, arrowstyle='->', color='black', density=1, linewidth=0.5)
ax5.set_title('(e) ERA5', loc='left', fontsize=font_size, fontweight='bold')
...
st6 = ax6.streamplot(lon, lat, u_500_mme[:,:], v_500_mme[:,:], arrowsize=1, arrowstyle='->', color='black', density=1, linewidth=0.5)
ax6.set_title('(f) MME', loc='left', fontsize=font_size, fontweight='bold')
...
st7 = ax7.streamplot(lon, lat, u_500_mme_best[:,:], v_500_mme_best[:,:], arrowsize=1, arrowstyle='->', color='black', density=1, linewidth=0.5)
ax7.set_title('(g) MME-best', loc='left', fontsize=font_size, fontweight='bold')
...
st8 = ax8.streamplot(lon, lat, u_500_mme_worse[:,:], v_500_mme_worse[:,:], arrowsize=1, arrowstyle='->', color='black', density=1, linewidth=0.5)
ax8.set_title('(h) MME-worst', loc='left', fontsize=font_size, fontweight='bold')
configure_subplot(ax8)

cf9 = ax9.contourf(lon, lat, q_850_obs, levels=np.arange(0, 20.25, 0.25), transform=ccrs.PlateCarree(), extend='max', cmap=cmap_color)
st9 = ax9.streamplot(lon, lat, u_850_obs[:,:], v_850_obs[:,:], arrowsize=1, arrowstyle='->', color='black', density=1, linewidth=0.5)
ax9.set_title('(i) ERA5', loc='left', fontsize=font_size, fontweight='bold')
ax9.set_ylabel('850 hPa', fontsize=font_size, fontweight='bold')
configure_subplot(ax9)
cbar = plt.colorbar(cf9, cax=fig.add_axes([0.25, 0.09, 0.5, 0.02]), orientation='horizontal')
cbar.set_label('Specific humidity 850 hPa (g kg$^-$$^1$)', fontsize=font_size, fontweight='bold')
cbar.ax.tick_params(labelsize=font_size, direction='in')

cf10 = ax10.contourf(lon, lat, q_850_mme, levels=np.arange(0, 20.25, 0.25), transform=ccrs.PlateCarree(), extend='max', cmap=cmap_color)
st10 = ax10.streamplot(lon, lat, u_850_mme[:,:], v_850_mme[:,:], arrowsize=1, arrowstyle='->', color='black', density=1, linewidth=0.5)
ax10.set_title('(j) MME', loc='left', fontsize=font_size, fontweight='bold')
configure_subplot(ax10)

cf11 = ax11.contourf(lon, lat, q_850_mme_best, levels=np.arange(0, 20.25, 0.25), transform=ccrs.PlateCarree(), extend='max', cmap=cmap_color)
st11 = ax11.streamplot(lon, lat, u_850_mme_best[:,:], v_850_mme_best[:,:], arrowsize=1, arrowstyle='->', color='black', density=1, linewidth=0.5)
ax11.set_title('(k) MME-best', loc='left', fontsize=font_size, fontweight='bold')
configure_subplot(ax11)

cf12 = ax12.contourf(lon, lat, q_850_mme_worse, levels=np.arange(0, 20.25, 0.25), transform=ccrs.PlateCarree(), extend='max', cmap=cmap_color)
st12 = ax12.streamplot(lon, lat, u_850_mme_worse[:,:], v_850_mme_worse[:,:], arrowsize=1, arrowstyle='->', color='black', density=1, linewidth=0.5)
ax12.set_title('(l) MME-worst', loc='left', fontsize=font_size, fontweight='bold')
