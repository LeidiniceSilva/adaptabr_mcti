...
for i in range(1, 19):
	...
	clim_namz_cmip6.append(clim_namz_cmip[2])
	
	clim_samz_cmip = import_cmip(var_cmip6, 'SAMZ', cmip6[i][0], cmip6[i][1], dt)
	clim_samz_cmip6.append(clim_samz_cmip[2])

	clim_neb_cmip = import_cmip(var_cmip6, 'NEB', cmip6[i][0], cmip6[i][1], dt)
	clim_neb_cmip6.append(clim_neb_cmip[2])

	clim_sam_cmip = import_cmip(var_cmip6, 'SAM', cmip6[i][0], cmip6[i][1], dt)
	clim_sam_cmip6.append(clim_sam_cmip[2])

	clim_lpb_cmip = import_cmip(var_cmip6, 'LPB', cmip6[i][0], cmip6[i][1], dt)
	clim_lpb_cmip6.append(clim_lpb_cmip[2])

namz_cmip6 = np.array([clim_namz_obs[2], clim_namz_cmip6[0], clim_namz_cmip6[1], clim_namz_cmip6[2], clim_namz_cmip6[3], clim_namz_cmip6[4], 
...
samz_cmip6 = np.array([clim_samz_obs[2], clim_samz_cmip6[0], clim_samz_cmip6[1], clim_samz_cmip6[2], clim_samz_cmip6[3], clim_samz_cmip6[4], 
...
neb_cmip6 = np.array([clim_neb_obs[2], clim_neb_cmip6[0], clim_neb_cmip6[1], clim_neb_cmip6[2], clim_neb_cmip6[3], clim_neb_cmip6[4], 
...
sam_cmip6 = np.array([clim_sam_obs[2], clim_sam_cmip6[0], clim_sam_cmip6[1], clim_sam_cmip6[2], clim_sam_cmip6[3], clim_sam_cmip6[4], 
...
lpb_cmip6 = np.array([clim_lpb_obs[2], clim_lpb_cmip6[0], clim_lpb_cmip6[1], clim_lpb_cmip6[2], clim_lpb_cmip6[3], clim_lpb_cmip6[4], 
